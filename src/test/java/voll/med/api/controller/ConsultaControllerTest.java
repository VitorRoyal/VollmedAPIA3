...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Deve dever o codigo http 400 quando estiver com informações invalidas")
    @WithMockUser
    ...
    @Test
    @DisplayName("Deve dever o codigo http 200 quando estiver com informações validas")
    @WithMockUser
